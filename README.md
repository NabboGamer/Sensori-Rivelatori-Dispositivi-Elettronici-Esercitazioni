...
Il lavoro è stato svolto ponendo la massima attenzione sia sulla correttezza teorica che implementativa. Nonostante ciò, è possibile che siano presenti errori teorici o implementativi: in tal caso, segnalazioni e contributi (ad esempio tramite merge request) sono benvenuti.

## Galleria

**Esercitazione A — Simulazione numerica (MATLAB)**
![Esercitazione A — Simulazione numerica (MATLAB)](./doc/screenshots/screenshot_esercitazione_a_gui_langevin_concentratore.png)

**Esercitazione B — Simulazione FEM (Ansys)**
![Esercitazione B — Simulazione FEM (Ansys)](./doc/screenshots/screenshot_esercitazione_b_langevin_concentratore.png)

**Esercitazione C — Analisi biometrica (MATLAB)**
![Esercitazione C — Analisi biometrica (MATLAB)](./doc/screenshots/screenshot_esercitazione_c_matching_3d.png)
