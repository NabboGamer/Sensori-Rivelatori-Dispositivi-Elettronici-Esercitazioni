function G = calcolaMatriceG(A, B)
    ...
    G11 = A{1,1} - ( (A{1,2}.^2) ./ (A{1,1} + B{1,1}) );

    G12 = (A{1,2} .* B{1,2}) ./ (A{1,1} + B{1,1});

    G13 = ( A{1,3} - ((A{1,2}.*A{1,3})./(A{1,1}+B{1,1})) + ((A{1,2}.*B{1,3})./(A{1,1}+B{1,1})) ) ./ 2;
    ...
    % nostra modellazione non è contemplato.
    %--------------------------------------------------------------------------------------------------%
    G22 = B{1,1} - ( (B{1,2}.^2) ./ (A{1,1} + B{1,1}) );
    G23 = ( B{1,3} - ((B{1,2}.*B{1,3})./(A{1,1}+B{1,1})) + ((A{1,3}.*B{1,2})./(A{1,1}+B{1,1})) ) ./ 2;
    %--------------------------------------------------------------------------------------------------%
    ...
    G33 = ( ...
          (A{3,3}./2) + ...
          (B{3,3}./2) - ...
          ( (B{1,3}.^2) ./ (2.*(A{1,1}+B{1,1})) ) - ...
          ( (A{1,3}.^2) ./ (2.*(A{1,1}+B{1,1})) ) + ...
          ( (A{1,3}.*B{1,3}) ./ (A{1,1}+B{1,1}) ) ...
          ) ./ 2;
