function templateImg = generaTemplateBH4(percorsoImmagine, percorsoProcessing, numStr, scelta)
    ...
    %% 4) Applicazione filtro Bottom Hat 4 direzioni
    bottomHatFilteredImage = filtroBottomHat4Way(filteredImage);
    imwrite(bottomHatFilteredImage, strcat(percorsoProcessing, '04.BH4_', numStr, '.jpg'));
    
    %% 6) Aumento contrasto
    contrastAdjusted = imadjust(bottomHatFilteredImage, stretchlim(bottomHatFilteredImage), []);
